...
function AddArticle(props) {
  ...
  useEffect(() => {
    ...
    console.log('tmpId', props.match, tmpId)
    if (tmpId) {
      setIsLoadding(true)
      setArticleId(tmpId)
  ...
  const saveArticle = () => {
    ...
    let dataProps = {}
    console.log('saveArticle', selectedType)
          ...
          <Row gutter={5}>
            ...
            <Col span={6}>
              <Row>
                ...
                <Col span={12}>
                  <div className="date-select">
                    <DatePicker size="large" onChange={(date, dateString) => setUpdateDate(dateString)} placeholder="修改日期" />
                  </div>
                </Col>
              </Row>
            </Col>
